...
import MetricCard from '../Interface/MetricCard'
const Container = () => {
  return <div class="container w-full mx-auto pt-20">
        <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
        <div class="flex flex-wrap">
        <MetricCard name="Total Revenue" icon="font-bold text-3xl" value="3000" optionColor="text-green-500" optionIcon="fas fa-caret-up"/>
